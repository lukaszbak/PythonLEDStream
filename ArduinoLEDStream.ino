    ...
    //Slightly Modified version of the modified version of the adalight protocol implementation that uses FastLED
    //Still a work in progess as button are to be added (hopefully)
    ...
    #define NUM_LEDS 30 // Max LED count
    #define LED_PIN 10 // arduino output pin - probably not required for WS2801
    //#define GROUND_PIN 12 // probably not required for WS2801
    ...
    static const unsigned long serialTimeout = 20000; // 20 seconds
